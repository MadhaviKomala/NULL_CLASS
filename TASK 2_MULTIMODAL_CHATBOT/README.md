Task 2: Multi-Modal Chatbot Simulates a multi-modal chatbot handling text and image inputs (image mocked as text description due to resource constraints). Setup
